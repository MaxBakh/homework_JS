var userAnswer, goals = 0, wrongAnswer = 0; point = 0; 
for (var index = 0; index < questions.length; index++) {
    ...
    if (userAnswer == questions[index].correct) {
        point += (index+1)*1000;
        alert("Поздравляем вы ответили правильно и получаете  за ответ "+((index+1)*1000)+" очков");
        goals++;
        }
    else {
        wrongAnswer++;
...
alert("Вы  ответиили правильно на "+goals+" вопросов из "+questions.length+" и заработали за игру "+ point +" очков"); 
